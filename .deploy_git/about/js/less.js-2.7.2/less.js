...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.less = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return 1000="" s})({1:[function(require,module,exports){="" var="" adddataattr="require("./utils").addDataAttr," browser="require("./browser");" module.exports="function(window," options)="" {="" use="" options="" from="" the="" current="" script="" tag="" data="" attribues="" adddataattr(options,="" browser.currentscript(window));="" if="" (options.isfileprotocol="==" undefined)="" options.isfileprotocol="/^(file|(chrome|safari)(-extension)?|resource|qrc|app):/.test(window.location.protocol);" }="" load="" styles="" asynchronously="" (default:="" false)="" this="" is="" set="" to="" `false`="" by="" default,="" so="" that="" body="" doesn't="" start="" loading="" before="" stylesheets="" are="" parsed.="" setting="" `true`="" can="" result="" in="" flickering.="" options.async="options.async" ||="" false;="" options.fileasync="options.fileAsync" interval="" between="" watch="" polls="" options.poll="options.poll" ?="" :="" 1500);="" options.env="options.env" (window.location.hostname="=" '127.0.0.1'="" window.location.hostname="=" '0.0.0.0'="" 'localhost'="" (window.location.port="" &&="" window.location.port.length=""> 0)      ||
...
var colorBlendModeFunctions = {
    ...
    overlay: function(cb, cs) {
        cb *= 2;
        return (cb <= 1)="" ?="" colorblendmodefunctions.multiply(cb,="" cs)="" :="" colorblendmodefunctions.screen(cb="" -="" 1,="" cs);="" },="" softlight:="" function(cb,="" {="" var="" d="1," e="cb;" if="" (cs=""> 0.5) {
            e = 1;
...
colorFunctions = {
    ...
    hsla: function (h, s, l, a) {
        ...
        m2 = l <= 0="" 1="" 2="" 360="" 0.5="" ?="" l="" *="" (s="" +="" 1)="" :="" s="" -="" s;="" m1="l" m2;="" return="" colorfunctions.rgba(hue(h="" 3)="" 255,="" hue(h)="" hue(h="" a);="" },="" hsv:="" function(h,="" s,="" v)="" {="" colorfunctions.hsva(h,="" v,="" 1.0);="" hsva:="" a)="" h="((number(h)" %="" 360)="" 360;="" v="number(v);" a="number(a);" var="" i,="" f;="" i="Math.floor((h" 60)="" 6);="" f="(h" i;="" vs="[v," (1="" s),="" f)="" s)];="" perm="[[0," 3,="" 1],="" [2,="" 0,="" [1,="" 3],="" 2,="" 0],="" [3,="" 1,="" [0,="" 2]];="" colorfunctions.rgba(vs[perm[i][0]]="" vs[perm[i][1]]="" vs[perm[i][2]]="" hue:="" function="" (color)="" new="" dimension(color.tohsl().h);="" saturation:="" dimension(color.tohsl().s="" 100,="" '%');="" lightness:="" dimension(color.tohsl().l="" hsvhue:="" function(color)="" dimension(color.tohsv().h);="" hsvsaturation:="" dimension(color.tohsv().s="" hsvvalue:="" dimension(color.tohsv().v="" red:="" dimension(color.rgb[0]);="" green:="" dimension(color.rgb[1]);="" blue:="" dimension(color.rgb[2]);="" alpha:="" dimension(color.tohsl().a);="" luma:="" dimension(color.luma()="" color.alpha="" luminance:="" luminance="(0.2126" color.rgb[0]="" 255)="" (0.7152="" color.rgb[1]="" (0.0722="" color.rgb[2]="" 255);="" dimension(luminance="" saturate:="" (color,="" amount,="" method)="" filter:="" saturate(3.2);="" should="" be="" kept="" as="" is,="" so="" check="" for="" color="" if="" (!color.rgb)="" null;="" }="" hsl="color.toHSL();" (typeof="" method="" !="=" "undefined"="" &&="" method.value="==" "relative")="" hsl.s="" amount.value="" 100;="" else="" hsla(hsl);="" desaturate:="" lighten:="" hsl.l="" darken:="" fadein:="" hsl.a="" fadeout:="" fade:="" amount)="" spin:="" hue="(hsl.h" amount.value)="" hsl.h="hue" <="" hue;="" copyright="" (c)="" 2006-2009="" hampton="" catlin,="" natalie="" weizenbaum,="" and="" chris="" eppstein="" http:="" sass-lang.com="" mix:="" (color1,="" color2,="" weight)="" (!color1.tohsl="" ||="" !color2.tohsl)="" console.log(color2.type);="" console.dir(color2);="" (!weight)="" weight="new" dimension(50);="" p="weight.value" 100.0;="" w="p" 1;="" color2.tohsl().a;="" w1="(((w" -1)="" (w="" a))="" 2.0;="" w2="1" w1;="" rgb="[color1.rgb[0]" color2.rgb[0]="" w2,="" color1.rgb[1]="" color2.rgb[1]="" color1.rgb[2]="" color2.rgb[2]="" w2];="" alpha="color1.alpha" color2.alpha="" p);="" color(rgb,="" alpha);="" greyscale:="" colorfunctions.desaturate(color,="" dimension(100));="" contrast:="" dark,="" light,="" threshold)="" contrast(3.2);="" light="==" 'undefined')="" dark="==" figure="" out="" which="" is="" actually="" dark!="" (dark.luma()=""> light.luma()) {
            var t = light;
            light = dark;
            dark = t;
        }
...
module.exports = function(environment) {
    ...
    functionRegistry.add("svg-gradient", function(direction) {
        ...
        for (i = 0; i < stops.length; i+= 1) {
            ...
            alpha = color.alpha;
            returner += '<stop 1="" offset="' + positionValue + '" stop-color="' + color.toRGB() + '" '="" +="" (alpha="" <="" ?="" stop-opacity="' + alpha + '" :="" '')=""/>';
        }
        returner += '</'>' +
...
module.exports = function (input, fail) {
    ...
    for (chunkerCurrentIndex = 0; chunkerCurrentIndex < len; chunkerCurrentIndex++) {
        ...
        if (((cc >= 97) && (cc <= 122))="" ||="" (cc="" <="" 34))="" {="" a-z="" or="" whitespace="" continue;="" }="" switch="" (cc)="" case="" 40:="" (="" parenlevel++;="" lastopeningparen="chunkerCurrentIndex;" 41:="" )="" if="" (--parenlevel="" 0)="" return="" fail("missing="" opening="" `(`",="" chunkercurrentindex);="" 59:="" ;="" (!parenlevel)="" emitchunk();="" 123:="" level++;="" lastopening="chunkerCurrentIndex;" 125:="" (--level="" `{`",="" (!level="" &&="" !parenlevel)="" 92:="" \="" (chunkercurrentindex="" len="" -="" 1)="" chunkercurrentindex++;="" fail("unescaped="" `\\`",="" 34:="" 39:="" 96:="" ",="" '="" and="" `="" matched="0;" currentchunkstartindex="chunkerCurrentIndex;" for="" +="" 1;="" chunkercurrentindex="" len;="" chunkercurrentindex++)="" cc2="input.charCodeAt(chunkerCurrentIndex);" (cc2=""> 96) { continue; }
            ...
            case 47:                        // /, check for comment
                ...
                if (cc2 == 47) {
                    ...
                    for (chunkerCurrentIndex = chunkerCurrentIndex + 2; chunkerCurrentIndex < len; chunkerCurrentIndex++) {
                        ...
                        if ((cc2 <= 13)="" &&="" ((cc2="=" 10)="" ||="" (cc2="=" 13)))="" {="" break;="" }="" else="" if="" 42)="" *,="" find="" *="" lastmulticomment="currentChunkStartIndex" =="" chunkercurrentindex;="" for="" (chunkercurrentindex="chunkerCurrentIndex" +="" 2;="" chunkercurrentindex="" <="" len="" -="" 1;="" chunkercurrentindex++)="" cc2="input.charCodeAt(chunkerCurrentIndex);" 125)="" lastmulticommentendbrace="chunkerCurrentIndex;" !="42)" continue;="" (input.charcodeat(chunkercurrentindex="" 1)="=" 47)="" return="" fail("missing="" closing="" `*="" `",="" currentchunkstartindex);="" chunkercurrentindex++;="" case="" 42:="" check="" unmatched="" ((chunkercurrentindex="" 47))="" fail("unmatched="" `="" *`",="" chunkercurrentindex);="" (level="" 0)="" ((lastmulticomment=""> lastOpening) && (lastMultiCommentEndBrace > lastMultiComment)) {
            ...
            atomicCondition: function () {
                ...
                if (a) {
                    ...
                    if (parserInput.$char('<')) {="" if="" (parserinput.$char('=")) {
                            ...
                            op = " <';="" }="" else="">')) {
                            op = "=>";
                        } else if (parserInput.$char('<')) 2="" {="" op="=<" ;="" }="" else="" if="" (op)="" b="this.addition()" ||="" entities.keyword()="" entities.quoted();="" (b)="" c="new(tree.Condition)(op," a,="" b,="" index,="" false);="" error('expected="" expression');="" new(tree.keyword)('true'),="" return="" c;="" },="" an="" operand="" is="" anything="" that="" can="" be="" part="" of="" operation,="" such="" as="" a="" color,="" or="" variable="" operand:="" function="" ()="" var="" entities="this.entities," negate;="" (parserinput.peek(="" ^-[@\(]="" ))="" negate="parserInput.$char('-');" o="this.sub()" entities.dimension()="" entities.color()="" entities.variable()="" entities.call()="" entities.colorkeyword();="" (negate)="" o.parensinop="true;" o;="" expressions="" either="" represent="" mathematical="" operations,="" white-space="" delimited="" entities.="" 1px="" solid="" black="" @var="" *="" expression:="" e,="" delim;="" do="" e="this.comment();" (e)="" entities.push(e);="" continue;="" this.entity();="" operations="" not="" allow="" keyword="" "="" dimension="" (e.g.="" small="" 20px)="" so="" we="" support="" here="" (!parserinput.peek(="" ^\="" [\="" *]="" delim="parserInput.$char('/');" (delim)="" entities.push(new(tree.anonymous)(delim));="" while="" (e);="" (entities.length=""> 0) {
...
Color.prototype.luma = function () {
    ...
    r = (r <= 0.03928)="" ?="" r="" 12.92="" :="" math.pow(((r="" +="" 0.055)="" 1.055),="" 2.4);="" g="(g" <="0.03928)" math.pow(((g="" b="(b" math.pow(((b="" return="" 0.2126="" *="" 0.7152="" 0.0722="" b;="" };="" color.prototype.gencss="function" (context,="" output)="" {="" output.add(this.tocss(context));="" color.prototype.tocss="function" donotcompress)="" var="" compress="context" &&="" context.compress="" !donotcompress,="" color,="" alpha;="" `value`="" is="" set="" if="" this="" color="" was="" originally="" converted="" from="" a="" named="" string="" so="" we="" need="" to="" respect="" and="" try="" output="" too.="" (this.value)="" this.value;="" }="" have="" some="" transparency,="" the="" only="" way="" represent="" it="" via="" `rgba`.="" otherwise,="" use="" hex="" representation,="" which="" has="" better="" compatibility="" with="" older="" browsers.="" values="" are="" capped="" between="" `0`="" `255`,="" rounded="" zero-padded.="" alpha="this.fround(context," this.alpha);="" (alpha="" 1)="" "rgba("="" this.rgb.map(function="" (c)="" clamp(math.round(c),="" 255);="" }).concat(clamp(alpha,="" 1))="" .join(','="" (compress="" ''="" '="" '))="" ")";="" (compress)="" splitcolor="color.split('');" convert="" short="" format="" (splitcolor[1]="==" splitcolor[2]="" splitcolor[3]="==" splitcolor[4]="" splitcolor[5]="==" splitcolor[6])="" splitcolor[1]="" splitcolor[5];="" color;="" operations="" be="" done="" per-channel,="" not,="" channels="" will="" spill="" onto="" each="" other.="" once="" our="" result,="" in="" form="" of="" an="" integer="" triplet,="" create="" new="" node="" hold="" result.="" color.prototype.operate="function" op,="" other)="" rgb="[];" (1="" -="" other.alpha)="" other.alpha;="" for="" (var="" c="0;" 3;="" c++)="" rgb[c]="this._operate(context," this.rgb[c],="" other.rgb[c]);="" color(rgb,="" alpha);="" color.prototype.torgb="function" ()="" tohex(this.rgb);="" color.prototype.tohsl="function" 255,="" max="Math.max(r," g,="" b),="" min="Math.min(r," b);="" h,="" s,="" l="(max" min)="" 2,="" d="max" min;="" (max="==" h="s" =="" 0;="" else="" s="l"> 0.5 ? d / (2 - max - min) : d / (max + min);
...
Unit.prototype.isSingular = function() {
    return this.numerator.length <= 1="" &&="" this.denominator.length="==" 0;="" };="" unit.prototype.map="function(callback)" {="" var="" i;="" for="" (i="0;" i="" <="" this.numerator.length;="" i++)="" this.numerator[i]="callback(this.numerator[i]," false);="" }="" this.denominator.length;="" this.denominator[i]="callback(this.denominator[i]," true);="" unit.prototype.usedunits="function()" group,="" result="{}," mapunit,="" groupname;="" mapunit="function" (atomicunit)="" *jshint="" loopfunc:true="" *="" if="" (group.hasownproperty(atomicunit)="" !result[groupname])="" result[groupname]="atomicUnit;" return="" atomicunit;="" (groupname="" in="" unitconversions)="" (unitconversions.hasownproperty(groupname))="" group="unitConversions[groupName];" this.map(mapunit);="" result;="" unit.prototype.cancel="function" ()="" counter="{}," atomicunit,="" atomicunit="this.numerator[i];" counter[atomicunit]="(counter[atomicUnit]" ||="" 0)="" +="" 1;="" -="" this.numerator="[];" this.denominator="[];" (atomicunit="" counter)="" (counter.hasownproperty(atomicunit))="" count="counter[atomicUnit];" (count=""> 0) {
                for (i = 0; i < count; i++) {
 ...
 * @param  task A callable object, typically a function that takes no
 * arguments.
 */
module.exports = asap;
function asap(task) {
...
});</=></'></'></=></'))></'))></=></=></=></=></r.length;o++)s(r[o]);return></self@cloudhead.net>